			...
			<view class="agreement-section">
				<view class="agreement-checkbox" @click="toggleAgreement">
					...
					<view class="agreement-text">
						<text>我已阅读并同意</text>
						<text class="link-text" @click.stop="showUserAgreement"
							>《用户协议》</text
						>
						<text>和</text>
						<text class="link-text" @click.stop="showPrivacyPolicy"
							>《隐私政策》</text
						>
					</view>
				</view>
	...
	methods: {
		...
		showUserAgreement() {
			uni.showModal({
				title: "用户协议",
				content:
					"这里是用户协议内容，实际使用时应该跳转到完整的协议页面或显示详细内容。",
				confirmText: "我知道了",
				showCancel: false,
			});
		},
		...
		showPrivacyPolicy() {
			uni.showModal({
				title: "隐私政策",
				content:
					"这里是隐私政策内容，实际使用时应该跳转到完整的隐私政策页面或显示详细内容。",
				confirmText: "我知道了",
				showCancel: false,
			});
		},
